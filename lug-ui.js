...
function setupLugRows(rows) {
  ...
  const fields = ["Qty", "LL", "WL", "tL", "LsL", "LLg", "a", "LFC", "LhpL", "W1", "WhpL", "rhpL", "W'se", "br", "e", "rL", "ni", "no", "s", "g", "dh", "LL-LsL", "s*(ni-1)", "LLG-rL", "rL-br", "WL-2e-2g"];
  const measureFields = new Set(fields.filter((field) => !["Qty", "ni", "no"].includes(field)));
